...
const DonationCampaignsCard = ({ item }) => {
    const { _id, image, maximumDonation, highestTotal, lastDate, shortDescription } = item
    return (
        <div className="card lg:w-96 md:w-96 bg-base-100 shadow-xl my-6">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                    <Link to={`/petDetails/${_id}`}><button className="bg-sky-500 px-4 py-1 rounded-3xl text-white font-bold">View Details</button></Link>
                </div>
            </div>
        </div>
    );
