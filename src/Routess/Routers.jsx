...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://pet-adoption-server-pi.vercel.app/petListing/${params.id}`)
            },
            {
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://pet-adoption-server-pi.vercel.app/campaigns/${params.id}`)
            }
        ]
    },
    {
